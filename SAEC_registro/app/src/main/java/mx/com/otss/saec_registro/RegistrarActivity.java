...
public class RegistrarActivity extends AppCompatActivity {
                        ...
                        Response.Listener<String> responseListener = new Response.Listener<String>() {
                            ...
                            public void onResponse(String response) {
                                try {
                                    ...
                                    if (jsonArray == null) {
                                        Toast.makeText(RegistrarActivity.this, jsonArray.toString(), Toast.LENGTH_SHORT).show();
                                    } else {
                                    ...
                                    e.printStackTrace();
                                    Toast.makeText(RegistrarActivity.this, "No hay registros", Toast.LENGTH_SHORT).show();
                                }
                            }
                        };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mensaje.setText(Html.fromHtml(getString(R.string.detalle)));
