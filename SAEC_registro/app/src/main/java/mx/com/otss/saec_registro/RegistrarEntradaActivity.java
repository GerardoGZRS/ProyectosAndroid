                        ...
                        Response.Listener<String> responseListener = new Response.Listener<String>() {
                            ...
                            public void onResponse(String response) {
                                try {
                                    ...
                                    JSONObject js0onObject = null;
                                    Log.i("Recibo", "" + jsonArray);
                                    if (jsonArray == null) {
                                        Toast.makeText(RegistrarEntradaActivity.this, jsonArray.toString(), Toast.LENGTH_SHORT).show();
                                    } else {
                                        ...
                                        Intent intent4 = new Intent(getApplicationContext(), ListadoReporteActivity.class);
                                        intent4.putStringArrayListExtra("data", (ArrayList<String>) listdata);
                                        finish();
