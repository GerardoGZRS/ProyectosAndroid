...
import mx.com.otss.saec.adapdator.RegistDiarioAdapter;
...
public class RegistroGeneralActivity extends AppCompatActivity {
    ...
    private RegistDiarioAdapter mAdapter;
            ...
            switch (item.getItemId()) {
                ...
                case R.id.menu_inferior_adeudos:
                    if (!verificaConexion(getApplication())) {
                        ...
                        Response.Listener<String> responseListener = new Response.Listener<String>() {
                            ...
                            public void onResponse(String response) {
                                try {
                                    ...
                                    e.printStackTrace();
                                    Toast.makeText(RegistroGeneralActivity.this, "No existen alumnos con adeudos", Toast.LENGTH_SHORT).show();
                        ...
                        RequestQueue queue = Volley.newRequestQueue(RegistroGeneralActivity.this);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!verificaConexion(getApplication())) {
            ...
            recyclerView = (RecyclerView) findViewById(R.id.recycler_listadoRegistroDiario);
            etSearchBox = (EditText) findViewById(R.id.etSearchBox_reg_gral);
            mAdapter = new RegistDiarioAdapter(listA);
