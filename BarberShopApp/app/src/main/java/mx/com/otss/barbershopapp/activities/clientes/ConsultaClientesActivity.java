...
import mx.com.otss.barbershopapp.adapters.clientes.ConsultaClienteAdapter;
...
public class ConsultaClientesActivity extends AppCompatActivity {
    ...
    private ConsultaClienteAdapter mAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView = (RecyclerView) findViewById(R.id.recycler_view_consulta_clientes);
        listA = new ArrayList<>();
        ...
        mAdapter = new ConsultaClienteAdapter(listA);
