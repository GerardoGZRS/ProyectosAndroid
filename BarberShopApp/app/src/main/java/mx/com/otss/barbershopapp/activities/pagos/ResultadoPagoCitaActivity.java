...
import mx.com.otss.barbershopapp.adapters.pagos.ResultadoCitaPagoAdapter;
import mx.com.otss.barbershopapp.utils.BarberShop;
import mx.com.otss.barbershopapp.utils.Comunicador;
import mx.com.otss.barbershopapp.utils.RecyclerTouchListener;

public class ResultadoPagoCitaActivity extends AppCompatActivity {
    private String nombreFranquicia;
    private ArrayList<BarberShop> listA;
    private RecyclerView recyclerView;
    private ResultadoCitaPagoAdapter mAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_resultado_pago_cita);
        ...
        recyclerView = (RecyclerView) findViewById(R.id.recycler_view_resultado_consulta_pago_cita);

        listA = new ArrayList<>();

        for(BarberShop i: Comunicador.getOBJ()){
            al = new BarberShop();
            al.setIdIngresos(i.getIdIngresos());
            al.setIdCita(i.getIdCita());
            al.setTotal(i.getTotal());

        }
        listA.add(al);
        mAdapter = new ResultadoCitaPagoAdapter(listA);
