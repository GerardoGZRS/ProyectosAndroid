...
import mx.com.otss.barbershopapp.adapters.clientes.ResultadoFranquiciaClienteAdapter;
import mx.com.otss.barbershopapp.utils.BarberShop;
import mx.com.otss.barbershopapp.utils.Comunicador;
import mx.com.otss.barbershopapp.utils.RecyclerTouchListener;

public class ResultadoFranquiciaActivity extends AppCompatActivity {
    private String nombreFranquicia;
    private ArrayList<BarberShop> listA;
    private RecyclerView recyclerView;
    private ResultadoFranquiciaClienteAdapter mAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_resultado_franquicia);
        ...
        recyclerView = (RecyclerView) findViewById(R.id.recycler_view_resultado_clientes_franquicia);
        listA = new ArrayList<>();
        ...
        mAdapter = new ResultadoFranquiciaClienteAdapter(listA);
