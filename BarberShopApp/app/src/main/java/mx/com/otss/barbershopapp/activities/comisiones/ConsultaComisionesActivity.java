...
import mx.com.otss.barbershopapp.adapters.comisiones.ConsultaComisionesAdapter;
import mx.com.otss.barbershopapp.request.comisiones.ConsultaComisionIdRequest;
...
public class ConsultaComisionesActivity extends AppCompatActivity {
    private String nombreFranquicia;
    private ArrayList<BarberShop> listA ;
    private RecyclerView recyclerView;
    private ConsultaComisionesAdapter mAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_consulta_comisiones);
        ...
        recyclerView = (RecyclerView) findViewById(R.id.recycler_view_consulta_comisiones);
        ...
        for(BarberShop i: Comunicador.getOBJ()){
            ...
            al.setIdComision(i.getIdComision());
            al.setTipoComision(i.getTipoComision());
            al.setValorComision(i.getValorComision());
            al.setIdEmpleados(i.getIdEmpleados());

            listA.add(al);
        }
        mAdapter = new ConsultaComisionesAdapter(listA);
        ...
        recyclerView.addOnItemTouchListener(new RecyclerTouchListener(getApplicationContext(), recyclerView, new RecyclerTouchListener.ClickListener() {
            ...
            public void onClick(View view, int position) {
                ...
                Toast.makeText(getApplicationContext(), movie.getIdComision() + " is selected!", Toast.LENGTH_SHORT).show();
                ...
                if (!verificaConexion(getApplication())) {
                    ...
                    final String idComision = movie.getIdComision();
                    Response.Listener<String> responseListener = new Response.Listener<String>() {
                        ...
                        public void onResponse(String response) {
                            try {
                                ...
                                Intent intentComisionConsulta = new Intent(getApplicationContext(), ActualizarComisionesActivity.class);
                                finish();
                    ...
                    ConsultaComisionIdRequest consultaComisionIdRequest = new ConsultaComisionIdRequest(idComision, responseListener);
                    RequestQueue queue = Volley.newRequestQueue(getApplicationContext());
                    queue.add(consultaComisionIdRequest);
                }}
