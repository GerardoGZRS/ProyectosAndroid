...
import mx.com.otss.barbershopapp.utils.TemplatePdfPagosEmpleados;

public class ReportePagosEmpleadosActivity extends AppCompatActivity {
    ...
    private TemplatePdfPagosEmpleados pdf;
    private View v;
    private Menu menu;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_reporte_pagos_empleados);
        ...
        try {
            pdf = new TemplatePdfPagosEmpleados(getApplicationContext());
            pdf.openDocument();
