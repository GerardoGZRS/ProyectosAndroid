...
import mx.com.otss.barbershopapp.request.pagos.ConsultaPagoCitaRequest;
...
public class ConsultaPagoCitaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_consulta_pago_cita);
        ...
        recyclerView = (RecyclerView) findViewById(R.id.recycler_view_consulta_citas_pago);

        listA = new ArrayList<>();
        for(BarberShop i: Comunicador.getOBJ()){
            al = new BarberShop();
            al.setIdCita(i.getIdCita());
        ...
        recyclerView.addOnItemTouchListener(new RecyclerTouchListener(getApplicationContext(), recyclerView, new RecyclerTouchListener.ClickListener() {
            ...
            public void onClick(View view, int position) {
                ...
                Toast.makeText(getApplicationContext(), movie.getIdCita() + " is selected!", Toast.LENGTH_SHORT).show();
            String idCita = movie.getIdCita();
                    ...
                    Response.Listener<String> responseListener = new Response.Listener<String>() {
                        ...
                        public void onResponse(String response) {
                            try {
                                ...
                                Intent intentConsultarPago = new Intent(getApplicationContext(), ResultadoPagoCitaActivity.class);
                                ...
                                e.printStackTrace();
                                Toast.makeText(ConsultaPagoCitaActivity.this, "No hay registros", Toast.LENGTH_SHORT).show();
                            }
                        }
                    };

                    ConsultaPagoCitaRequest consultaPagoCitaRequest = new ConsultaPagoCitaRequest(idCita, responseListener);
                    RequestQueue queue = Volley.newRequestQueue(ConsultaPagoCitaActivity.this);
                    queue.add(consultaPagoCitaRequest);
                }
