...
import mx.com.otss.barbershopapp.request.promociones.EliminarPromocionesRequest;
...
public class EliminarPromocionesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_eliminar_promociones);
        ...
        for (BarberShop i : Comunicador.getOBJ()) {
            String nombrePromocion = i.getIdPromocion() + " "  + i.getNombrePromocion();
            arrayList.add(nombrePromocion);
        }

        spinner = (Spinner) findViewById(R.id.spinnerPromocion);
        ...
        spinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                Comunicador.limpiar();
                final String nombrePromocion = (String) parent.getItemAtPosition(position);
                final   String subCadena  = nombrePromocion.substring(0,2);
                ...
                if (!verificaConexion(getApplication())) {
                    ...
                    EliminarPromocionesRequest eliminarPromocionesRequest = new EliminarPromocionesRequest(subCadena,responseListener);
                    RequestQueue queue = Volley.newRequestQueue(getApplicationContext());
                    queue.add(eliminarPromocionesRequest);
                }
            }
