...
import mx.com.otss.barbershopapp.utils.TemplatePdfControlPromociones;

public class ReportePromocionesAcivity extends AppCompatActivity {
    ...
    private TemplatePdfControlPromociones pdf;
    private View v;
    private Menu menu;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_reporte_promociones_acivity);
        ...
        try {
            pdf = new TemplatePdfControlPromociones(getApplicationContext());
            pdf.openDocument();
