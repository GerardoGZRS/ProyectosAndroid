...
import mx.com.otss.barbershopapp.utils.TemplatePdfCitas;

public class ReporteCitasActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnObtenerReporte = (Button)findViewById(R.id.btnMostrarPdf);
        try {
            pdf = new TemplatePdfCitas(getApplicationContext());
            pdf.openDocument();
