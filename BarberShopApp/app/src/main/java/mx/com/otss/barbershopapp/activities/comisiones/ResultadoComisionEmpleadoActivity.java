...
import mx.com.otss.barbershopapp.adapters.comisiones.ResultadoComisionesEmpleadoAdapters;
import mx.com.otss.barbershopapp.utils.BarberShop;
import mx.com.otss.barbershopapp.utils.Comunicador;
import mx.com.otss.barbershopapp.utils.RecyclerTouchListener;

public class ResultadoComisionEmpleadoActivity extends AppCompatActivity {
    private String nombreFranquicia;
    private ArrayList<BarberShop> listA ;
    private RecyclerView recyclerView;
    private ResultadoComisionesEmpleadoAdapters mAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_resultado_comision_empleado);
        ...
        recyclerView = (RecyclerView) findViewById(R.id.recycler_view_consulta_comisiones_empleado_resultado);
        listA = new ArrayList<>();
        for(BarberShop i: Comunicador.getOBJ()){
            al = new BarberShop();
            String tipoComision = i.getTipoComision();
            String valorComision = i.getValorComision();
            al.setIdComision(i.getIdComision());
            al.setTipoComision(tipoComision);
            al.setValorComision(valorComision);
            al.setIdEmpleados(i.getIdEmpleados());
            Log.i("Datos: ", "" + i.getValorComision());

        }
        listA.add(al);

        mAdapter = new ResultadoComisionesEmpleadoAdapters(listA);
        ...
        recyclerView.addOnItemTouchListener(new RecyclerTouchListener(getApplicationContext(), recyclerView, new RecyclerTouchListener.ClickListener() {
            ...
            public void onClick(View view, int position) {
                ...
                Toast.makeText(getApplicationContext(), movie.getNombreEmpleado() + " is selected!", Toast.LENGTH_SHORT).show();
            }
