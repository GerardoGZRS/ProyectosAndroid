...
import mx.com.otss.barbershopapp.utils.TemplatePdfControlTurno;

public class ReporteControlTurnosActivity extends AppCompatActivity {
    ...
    private TemplatePdfControlTurno pdf;
    private View v;
    private Menu menu;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_reporte_turnos);
        ...
        try {
            pdf = new TemplatePdfControlTurno(getApplicationContext());
            pdf.openDocument();
