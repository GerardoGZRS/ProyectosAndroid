...
import mx.com.otss.barbershopapp.adapters.franquicias.ConsultaFranquiciaAdapter;
import mx.com.otss.barbershopapp.request.franquicias.ConsultaIdFranquiciasRequest;
...
public class ConsultaFranquiciasActivity extends AppCompatActivity {
    private String nombreFranquicia;
    private ArrayList<BarberShop> listA ;
    private RecyclerView recyclerView;
    private ConsultaFranquiciaAdapter mAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_consulta_franquicia);
        ...
        recyclerView = (RecyclerView) findViewById(R.id.recycler_view_consulta_franquicia);
        ...
        mAdapter = new ConsultaFranquiciaAdapter(listA);
        ...
        recyclerView.addOnItemTouchListener(new RecyclerTouchListener(getApplicationContext(), recyclerView, new RecyclerTouchListener.ClickListener() {
            ...
            public void onClick(View view, int position) {
                ...
                if (!verificaConexion(getApplication())) {
                    ...
                    Response.Listener<String> responseListener = new Response.Listener<String>() {
                        ...
                        public void onResponse(String response) {
                            try {
                                ...
                                Intent intentConsultar = new Intent(getApplicationContext(), ActualizarFranquiciaActivity.class);
                    ...
                    ConsultaIdFranquiciasRequest consultaIdFranquiciasRequest = new ConsultaIdFranquiciasRequest(idFranquicia, responseListener);
                    RequestQueue queue = Volley.newRequestQueue(getApplicationContext());
                    queue.add(consultaIdFranquiciasRequest);
