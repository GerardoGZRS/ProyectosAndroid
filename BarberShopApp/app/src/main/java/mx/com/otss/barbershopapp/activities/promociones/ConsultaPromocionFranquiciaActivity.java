...
import mx.com.otss.barbershopapp.adapters.promociones.ConsultaPromocionFranquiciaAdapter;
import mx.com.otss.barbershopapp.request.promociones.ConsultaPromocionesFranquiciaRequest;
...
public class ConsultaPromocionFranquiciaActivity extends AppCompatActivity {
    private String nombreFranquicia;
    private ArrayList<BarberShop> listA;
    private RecyclerView recyclerView;
    private ConsultaPromocionFranquiciaAdapter mAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_consulta_promocion_franquicia);
        ...
        recyclerView = (RecyclerView) findViewById(R.id.recycler_view_consulta_promocion_franquicia);
        ...
        mAdapter = new ConsultaPromocionFranquiciaAdapter(listA);
        ...
        recyclerView.addOnItemTouchListener(new RecyclerTouchListener(getApplicationContext(), recyclerView, new RecyclerTouchListener.ClickListener() {
            ...
            public void onClick(View view, int position) {
               ...
               String idFranquicia = movie.getIdFranquisia();
                if (!verificaConexion(getApplication())) {
                    ...
                    Response.Listener<String> responseListener = new Response.Listener<String>() {
                        ...
                        public void onResponse(String response) {
                            try {
                                ...
                                Intent intentConsultaPromocion = new Intent(getApplicationContext(), ResultadoPromocionActivity.class);
                    ...
                    ConsultaPromocionesFranquiciaRequest consultaPromocionesFranquiciaRequest = new ConsultaPromocionesFranquiciaRequest(idFranquicia,responseListener);
                    RequestQueue queue = Volley.newRequestQueue(getApplicationContext());
                    queue.add(consultaPromocionesFranquiciaRequest);
                }
                }
