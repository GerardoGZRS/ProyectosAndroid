...
import mx.com.otss.barbershopapp.utils.TemplatePdfControlHorarios;

public class ReporteHorariosActivity extends AppCompatActivity {
    ...
    private TemplatePdfControlHorarios pdf;
    private View v;
    private Menu menu;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_reporte_horarios);
        ...
        try {
            pdf = new TemplatePdfControlHorarios(getApplicationContext());
            pdf.openDocument();
