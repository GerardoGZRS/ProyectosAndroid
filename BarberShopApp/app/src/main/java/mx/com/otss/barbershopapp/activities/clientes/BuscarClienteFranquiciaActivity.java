...
import mx.com.otss.barbershopapp.adapters.clientes.ConsultaFranquiciaClienteAdapter;
import mx.com.otss.barbershopapp.request.clientes.ConsultaCFranquiciaRequest;
...
public class BuscarClienteFranquiciaActivity extends AppCompatActivity {
    private String nombreFranquicia;
    private ArrayList<BarberShop> listA ;
    private RecyclerView recyclerView;
    private ConsultaFranquiciaClienteAdapter mAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_buscar_cliente_franquicia);
        navigation = (BottomNavigationView) findViewById(R.id.navigation);
        navigation.setOnNavigationItemSelectedListener(mOnNavigationItemSelectedListener);
        menu = navigation.getMenu();
        menuItem = menu.getItem(3);
        menuItem.setChecked(true);
        recyclerView = (RecyclerView) findViewById(R.id.recycler_view_consulta_cliente_franquicia);
        listA = new ArrayList<>();
        for(BarberShop i: Comunicador.getOBJ()){
            ...
            al.setDireccionFranquisia(i.getDireccionFranquisia());
            al.setTelefonoFranquisia(i.getTelefonoFranquisia());
            al.setIngresosGenerales(i.getIngresosGenerales());
            listA.add(al);
        }

        mAdapter = new ConsultaFranquiciaClienteAdapter(listA);
        ...
        recyclerView.addOnItemTouchListener(new RecyclerTouchListener(getApplicationContext(), recyclerView, new RecyclerTouchListener.ClickListener() {
            ...
            public void onClick(View view, int position) {
                ...
                Toast.makeText(getApplicationContext(), movie.getIdFranquisia() + " is selected!", Toast.LENGTH_SHORT).show();
                if (!verificaConexion(getApplication())) {
                    Toast.makeText(getBaseContext(),
                            "Comprueba tu conexión a Internet.... ", Toast.LENGTH_SHORT)
                            .show();
                }else{
                    final String usuario = movie.getIdFranquisia();
                    Response.Listener<String> responseListener = new Response.Listener<String>() {
                        ...
                        public void onResponse(String response) {
                            ...
                            try {
                                ...
                                Intent intentConsultar = new Intent(getApplicationContext(), ResultadoFranquiciaActivity.class);
                                finish();
                                ...
                                e.printStackTrace();
                                Toast.makeText(BuscarClienteFranquiciaActivity.this, "No hay registros", Toast.LENGTH_SHORT).show();
                            }
                        }
                    };

                    ConsultaCFranquiciaRequest consultaCFranquiciaRequest = new ConsultaCFranquiciaRequest(usuario, responseListener);
                    RequestQueue queue = Volley.newRequestQueue(BuscarClienteFranquiciaActivity.this);
                    queue.add(consultaCFranquiciaRequest);
                }
            }
