...
import mx.com.otss.barbershopapp.request.empleados.EliminarEmpleadosRequest;
...
public class EliminarEmpleadoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for (BarberShop i : Comunicador.getOBJ()) {
            String nombreEmpleado = i.getNombreEmpleado();
            arrayList.add(nombreEmpleado);
        }
        spinner = (Spinner) findViewById(R.id.spinnerEmpleado);
        ...
        spinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (!verificaConexion(getApplication())) {
                        ...
                        public void onResponse(String response) {
                            ...
                            try {
                                ...
                                if (success == true ) {
                                    ...
                                    Intent intent = new Intent(getApplicationContext(), PrincipalEmpleadosActivity.class);
                                    intent.putExtra("nombreFranquicia", getNombreFranquicia());
                                    Comunicador.limpiar();
                                    finish();
                                    startActivity(intent);
                                } else if(nombreEmpleado.equals("Selecciona...") || success==false) {
                    ...
                    EliminarEmpleadosRequest eliminarEmpleadosRequest = new EliminarEmpleadosRequest(nombreEmpleado,responseListener);
                    RequestQueue queue = Volley.newRequestQueue(getApplicationContext());
                    queue.add(eliminarEmpleadosRequest);
                }
            }
