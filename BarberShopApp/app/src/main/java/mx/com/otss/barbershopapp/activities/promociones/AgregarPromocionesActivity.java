...
import mx.com.otss.barbershopapp.request.promociones.InsertarPromocionesRequest;
...
public class AgregarPromocionesActivity extends AppCompatActivity {
    private String nombreFranquicia;
    private Button buttonAgregarPromociones;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_agregar_promociones);
        ...
        spinnerFranquicia = (Spinner)findViewById(R.id.txtNombreFranquicia);
        ...
        ft.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!verificaConexion(getApplication())) {
                    ...
                    final String descripcionPromocion = txt2.getText().toString();
                    ...
                    if (nombrePromocion.equals("") || descripcionPromocion.equals("") || fechaInicio.equals("") || fechaFin.equals("") || nombreFranquicia.equals("")) {
                        ...
                        responseListener = new Response.Listener<String>() {
                            ...
                            public void onResponse(String response) {
                                ...
                                try {
                                    ...
                                    if (success == true) {
                                        Toast.makeText(AgregarPromocionesActivity.this, "Registro exitoso!!!!", Toast.LENGTH_SHORT).show();
                                    } else {
                                        Toast.makeText(AgregarPromocionesActivity.this, "Error al registrar", Toast.LENGTH_SHORT).show();
                                    }


                                } catch (JSONException e) {
                                    e.printStackTrace();
                                    Toast.makeText(AgregarPromocionesActivity.this, "Error", Toast.LENGTH_SHORT).show();
                                }
                            }
                        };
                    }

                    InsertarPromocionesRequest insertarPromocionesRequest = new InsertarPromocionesRequest(nombrePromocion, descripcionPromocion, fechaInicio, fechaFin, nombreFranquicia, responseListener);
                    RequestQueue queue = Volley.newRequestQueue(getApplicationContext());
                    queue.add(insertarPromocionesRequest);
                }
            }
        });
