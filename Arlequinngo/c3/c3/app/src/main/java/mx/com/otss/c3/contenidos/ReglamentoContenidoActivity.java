...
public class ReglamentoContenidoActivity extends AppCompatActivity implements TextToSpeech.OnInitListener {
    private TextToSpeech tts;
    private ImageView btnplay,btnpause;
    private String textos;
    private ReglamentosCompletosActivity c;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_reglamento_contenido);
        ...
        for(int i = 0; i<lista.size(); i++) {
            txtMostrar = (TextView)findViewById(R.id.txtT);
            txtMostrar.setText("" + lista.get(0).toString());
            txtCon = (TextView)findViewById(R.id.txtC);
            txtCon.setText("" + lista.get(1).toString());
        }
    ...
    private void hablarya() {
        textos=txtCon.getText().toString();
