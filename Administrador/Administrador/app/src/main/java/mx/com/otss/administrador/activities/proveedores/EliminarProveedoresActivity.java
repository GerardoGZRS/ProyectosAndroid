...
import mx.com.otss.administrador.adapters.proveedores.EliminarProveedoresAdapter;
...
public class EliminarProveedoresActivity extends AppCompatActivity {
    ...
    private EliminarProveedoresAdapter mAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView = (RecyclerView) findViewById(R.id.recycler_view_eliminar_proveedores);

        listA = new ArrayList<>();
        lista = getIntent().getStringArrayListExtra("dat");

        mAdapter = new EliminarProveedoresAdapter(listA);
