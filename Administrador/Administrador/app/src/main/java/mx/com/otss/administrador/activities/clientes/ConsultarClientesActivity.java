...
import mx.com.otss.administrador.adapters.clientes.ConsultaClientesAdapter;
...
public class ConsultarClientesActivity extends AppCompatActivity {
    ...
    private ConsultaClientesAdapter mAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAdapter = new ConsultaClientesAdapter(listA);
        ...
        recyclerView.addOnItemTouchListener(new RecyclerTouchListener(getApplicationContext(), recyclerView, new RecyclerTouchListener.ClickListener() {
            ...
            public void onClick(View view, int position) {
                ...
                Intent intentActualizar = new Intent(getApplicationContext(), ActualizarClientesActivity.class);
