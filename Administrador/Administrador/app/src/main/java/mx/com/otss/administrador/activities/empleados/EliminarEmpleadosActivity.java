...
import mx.com.otss.administrador.adapters.empleados.EliminarEmpleadosAdapter;
import mx.com.otss.administrador.utils.Administrador;
import mx.com.otss.administrador.utils.RecyclerTouchListener;

public class EliminarEmpleadosActivity extends AppCompatActivity {
    private ArrayList<Administrador> listA;
    private RecyclerView recyclerView;
    private EliminarEmpleadosAdapter mAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView = (RecyclerView) findViewById(R.id.recycler_view_eliminar_empleados);

        listA = new ArrayList<>();

        mAdapter = new EliminarEmpleadosAdapter(listA);
