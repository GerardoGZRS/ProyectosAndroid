...
import mx.com.otss.administrador.adapters.clientes.EliminarClientesAdapter;
import mx.com.otss.administrador.utils.Administrador;
import mx.com.otss.administrador.utils.RecyclerTouchListener;

public class EliminarClientesActivity extends AppCompatActivity {

    private ArrayList<Administrador> listA;
    private RecyclerView recyclerView;
    private EliminarClientesAdapter mAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_eliminar_clientes);
        navigation = (BottomNavigationView) findViewById(R.id.navigation);
        navigation.setOnNavigationItemSelectedListener(mOnNavigationItemSelectedListener);
        menu = navigation.getMenu();
        menuItem = menu.getItem(0);
        menuItem.setChecked(true);
        recyclerView = (RecyclerView) findViewById(R.id.recycler_view_eliminar_clientes);

        listA = new ArrayList<>();
        lista = getIntent().getStringArrayListExtra("dat");

        mAdapter = new EliminarClientesAdapter(listA);
