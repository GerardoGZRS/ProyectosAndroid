...
import mx.com.otss.administrador.adapters.proveedores.ConsultaProveedoresAdapter;
import mx.com.otss.administrador.utils.Administrador;
import mx.com.otss.administrador.utils.RecyclerTouchListener;

public class ConsultarProveedoresActivity extends AppCompatActivity {


    private ArrayList<Administrador> listA;
    private RecyclerView recyclerView;
    private ConsultaProveedoresAdapter mAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView = (RecyclerView) findViewById(R.id.recycler_view_consulta_proveedores);

        listA = new ArrayList<>();
        lista = getIntent().getStringArrayListExtra("dat");

        mAdapter = new ConsultaProveedoresAdapter(listA);
        ...
        recyclerView.addOnItemTouchListener(new RecyclerTouchListener(getApplicationContext(), recyclerView, new RecyclerTouchListener.ClickListener() {
            ...
            public void onClick(View view, int position) {
                ...
                Intent intentActualizar = new Intent(getApplicationContext(), ActualizarProveedoresActivity.class);
