...
import mx.com.otss.administrador.adapters.empleados.ConsultaEmpleadosAdapter;
import mx.com.otss.administrador.utils.Administrador;
import mx.com.otss.administrador.utils.RecyclerTouchListener;

public class ConsultarEmpleadosActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_consultar_empleados);
        ...
        recyclerView.addOnItemTouchListener(new RecyclerTouchListener(getApplicationContext(), recyclerView, new RecyclerTouchListener.ClickListener() {
            ...
            public void onClick(View view, int position) {
                ...
                Intent intentActualizar = new Intent(getApplicationContext(), ActualizarEmpleadosActivity.class);
